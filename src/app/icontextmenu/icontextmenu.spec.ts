...
import { IContextMenu, IContextMenuSub } from './icontextmenu';
import { NoopAnimationsModule } from '@angular/platform-browser/animations';
import { RouterTestingModule } from '@angular/router/testing';

describe('TieredMenu', () => {
  
    let tieredmenu: IContextMenu;
    let fixture: ComponentFixture<IContextMenu>;
    ...
    beforeEach(() => {
      ...
      fixture = TestBed.createComponent(IContextMenu);
    ...
    it('should change autoZindex', () => {
      ...
      const subMenuEl = fixture.debugElement.query(By.css('icontextmenusub')).componentInstance;
    ...
    it('should call itemClick when click', () => {
      ...
      const subMenuComponent = fixture.debugElement.query(By.css('icontextmenusub')).componentInstance as IContextMenuSub;
    ...
    it('should call onItemMouseEnter when mouseenter (on root)', () => {
      ...
      const secondSubMenu = items.children[0].query(By.css("icontextmenusub")).query(By.css('ul'));
